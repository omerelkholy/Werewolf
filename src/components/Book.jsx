    ...
    const storyPages = {
        ...
        ar: [
            ...
            },
            {
                ...
                content: `في ليلةٍ شاحبةٍ أثقلها السكون، كانت أنوار القمر تعلّق كأنفاسٍ من فضّة فوق الأزقة المعوجّة ل هاولينغ هولو، غطّى الصمت القرية بأسرها. لم يكن صمتَ طمأنينة، بل سكونَ من يحبس أنفاسه في خوفٍ عظيم، وكأن قوى خفية، عتيقة وغاضبة، تُعدّ العدة لغزو أرض البشر. ارتجف الهواء ذاته، وعرف كل من بقي حيًّا: إن تأخروا كثيرًا، فإن روحًا بريئة أخرى ستسقط لا محالة قبل بزوغ الفجر.   
            `,
                imagePosition: "top",
                image: scene5
            },
