  ...
  return (
    <div className="flex flex-col items-center justify-center text-center px-4 py-6 space-y-5 w-full">
      ...
      <motion.div
        ...
        className="bg-amber-900/40 backdrop-blur-sm rounded-lg px-6 py-5 w-full max-w-sm border border-amber-600/40 text-amber-100 shadow-inner"
      >
        <p className="text-xl">
          Your goal is to <span className="text-white font-semibold">get voted out</span>.
        </p>
      </motion.div>
